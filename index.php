                ...
                <div class="col-lg-12 mx-auto">
                    <p class="large text-muted">
                        ...
                        <div id="more" style="display: none">
                            &emsp;Движущая сила маркетинга, которой мало кто пользуется – это честность! Честность определяет долговременность и масштабность, а люди, объединенные общей идеей, которой они делятся – это направляющая сила, которая определяет глубину и содержание проекта.<br><br>
                            &emsp;Мы временно ограничиваем доступ к получению статуса решающего голоса в кооперативе, потому что мы очень тревожимся, что из-за человеческого фактора, который очень часто не дает развиваться кооперативам, можем потерять темпы и концентрацию на выбранных целях, но в последующем, когда вся система будет полностью налажена –  мы это изменим.<br><br>
